...
def main(config_file, exp_suffix):
    ...
    if args.status == 0:
        from model.deeplabv3 import get_deeplab_v3_FL_Adapt as get_deeplab_v3
        from domain_adaptation.eval_UDA_single_FL import evaluate_domain_adaptation

    # For entropy-level adaptation
    if args.status == 1:
        from model.deeplabv3 import get_deeplab_v3_FL_Adapt as get_deeplab_v3
        from domain_adaptation.eval_UDA_single_EL import evaluate_domain_adaptation
    ...
    # dataloaders
    #pdb.set_trace()
    test_dataset = Chicago(root=cfg.DATA_DIRECTORY_TARGET,
                                     list_path='../dataset/Chicago/{}.txt',
    ...
    #                                  list_path='../dataset/Vaihingen/{}.txt',
    #                                  set=cfg.TEST.SET_TARGET,
    #                                  info_path=cfg.TEST.INFO_TARGET,
    #                                  crop_size=cfg.TEST.INPUT_SIZE_TARGET,
    #                                  mean=cfg.TEST.IMG_MEAN,
    ...
    #                          list_path='../dataset/PotsdamRGB/{}.txt',
    #                          set=cfg.TEST.SET_TARGET,
    #                          info_path=cfg.TEST.INFO_TARGET,
    #                          crop_size=cfg.TEST.INPUT_SIZE_TARGET,
    #                          mean=cfg.TEST.IMG_MEAN)
